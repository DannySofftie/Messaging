...
<span class="alert alert-warning col-lg-12 col-md-12 col-sm-12">
    <strong>Error! </strong>No phone numbers exist in your records.
</span>
...
<span class="alert alert-success col-lg-12 col-md-12 col-sm-12">
    You have
    <span class="badge badge-success">
        <?php echo $phoneNoQuery->rowCount();  ?>
    </span>phone numbers.
</span>
<ul>
...
<button type="button" class="btn btn-sm btn-outline-danger text-uppercase" id="send_premium">
    send premium
    <span class="mdi mdi-currency-usd"></span>
</button>&nbsp;
<button type="button" class="btn btn-sm btn-outline-info text-uppercase" id="send_free">
    send free
...
<hr style="visibility: hidden;" />
<div class="message_sent_status"></div>
